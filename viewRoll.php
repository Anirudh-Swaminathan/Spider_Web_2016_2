...
<html>
	<head>
		<title>View All Students In Ascending Order of Roll Number</title>
	</head>
<body>
<?php
require "connect.php";
...
$message = "Hello";
$sql = $conn->prepare("SELECT Name,Roll,Dept,Email,Address,About FROM spider_2016_2 order by Roll ASC");
